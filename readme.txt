...
<a href="//qsandbox.com/?utm_source=orbisius-cyberstore&utm_medium=sidebar&utm_campaign=product_readme"
    target="_blank">Free Test/Staging Site</a> (quick set up).
    Test drive plugins & themes without the risk of crashing your main site. Import your existing site (<span title="Paid feature">$</span>) and make improvements.
</a>
...
The plugin has several cool <a href="http://orbisius.com/products/wordpress-plugins/orbisius-cyberstore/extensions/" title="Orbisius CyberStore Extensions" target="_blank">Extensions</a>
...
= Support =
> Support is handled on our site: <a href="http://orbisius.com/forums/forum/community-support-forum/wordpress-plugins/orbisius-cyberstore/" target="_blank" title="[new window]">http://orbisius.com/support/</a>
> Please do NOT use the WordPress forums or other places to seek support.
> New: We have launched our <a href="http://orbisius.com/products/" target="_blank" title="[new window]">membership site</a>
...
= 2.1.6 =
* Changed internal links from club.orbisius.com orbisius.com
